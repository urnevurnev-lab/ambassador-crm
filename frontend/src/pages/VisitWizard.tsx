...
const TrainingForm = ({ onChange }: { onChange: (data: any) => void }) => (
  <div className="space-y-4">
    ...
    <div className="bg-white p-4 rounded-2xl border border-gray-100 flex items-center justify-center h-32 border-dashed border-2 border-gray-200 text-gray-400 gap-2">
        <Camera size={24}/>
...
const DefaultForm = ({ onChange }: { onChange: (data: any) => void }) => (
  <div className="bg-white p-4 rounded-2xl border border-gray-100">
    <textarea 
        className="w-full h-32 p-3 text-sm border border-gray-200 rounded-xl outline-none focus:border-black"
